...
static const absl::node_hash_map<verilog_tokentype, FTT>& FormatTokenTypeMap() {
  static const absl::node_hash_map<verilog_tokentype, FTT> kFormatTokenMap({
      ...
      //{verilog_tokentype::TK_bool, FTT::keyword},
      ...
      //{verilog_tokentype::TK_above, FTT::keyword},
      {verilog_tokentype::TK_abs, FTT::keyword},
      {verilog_tokentype::TK_absdelay, FTT::keyword},
      {verilog_tokentype::TK_abstol, FTT::keyword},
      {verilog_tokentype::TK_access, FTT::keyword},
      {verilog_tokentype::TK_acos, FTT::keyword},
      {verilog_tokentype::TK_acosh, FTT::keyword},
      ...
      {verilog_tokentype::TK_asin, FTT::keyword},
      {verilog_tokentype::TK_asinh, FTT::keyword},
      {verilog_tokentype::TK_atan, FTT::keyword},
      {verilog_tokentype::TK_atan2, FTT::keyword},
      {verilog_tokentype::TK_atanh, FTT::keyword},
      //{verilog_tokentype::TK_branch, FTT::keyword},
      {verilog_tokentype::TK_ceil, FTT::keyword},
      //{verilog_tokentype::TK_connect, FTT::keyword},
      ...
      {verilog_tokentype::TK_cos, FTT::keyword},
      {verilog_tokentype::TK_cosh, FTT::keyword},
      //{verilog_tokentype::TK_ddt, FTT::keyword},
      {verilog_tokentype::TK_ddt_nature, FTT::keyword},
      //{verilog_tokentype::TK_ddx, FTT::keyword},
      ...
      {verilog_tokentype::TK_exp, FTT::keyword},
      //{verilog_tokentype::TK_final_step, FTT::keyword},
      {verilog_tokentype::TK_flicker_noise, FTT::keyword},
      {verilog_tokentype::TK_floor, FTT::keyword},
      {verilog_tokentype::TK_flow, FTT::keyword},
      {verilog_tokentype::TK_from, FTT::keyword},
      //{verilog_tokentype::TK_ground, FTT::keyword},
      {verilog_tokentype::TK_hypot, FTT::keyword},
      //{verilog_tokentype::TK_idt, FTT::keyword},
      //{verilog_tokentype::TK_idtmod, FTT::keyword},
      {verilog_tokentype::TK_idt_nature, FTT::keyword},
      {verilog_tokentype::TK_inf, FTT::keyword},
      {verilog_tokentype::TK_infinite, FTT::keyword},
      //{verilog_tokentype::TK_initial_step, FTT::keyword},
      ...
      {verilog_tokentype::TK_ln, FTT::keyword},
      {verilog_tokentype::TK_log, FTT::keyword},
      {verilog_tokentype::TK_max, FTT::keyword},
      //{verilog_tokentype::TK_merged, FTT::keyword},
      ...
      {verilog_tokentype::TK_pow, FTT::keyword},

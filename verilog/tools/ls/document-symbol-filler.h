...
#ifndef DOCUMENT_SYMBOL_FILLER_H
#define DOCUMENT_SYMBOL_FILLER_H
...
class DocumentSymbolFiller : public verible::SymbolVisitor {
 public:
  ...
  explicit DocumentSymbolFiller(bool kate_workaround, absl::string_view base,
                                verible::lsp::DocumentSymbol *toplevel)
      : kModuleSymbolKind(kate_workaround ? SymbolKind::Method
                                          : SymbolKind::Module),
        kBlockSymbolKind(kate_workaround ? SymbolKind::Class
...
#endif  // DOCUMENT_SYMBOL_FILLER_H

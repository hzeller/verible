...
const ParsedBuffer *BufferTrackerContainer::GetCurrent(const std::string &uri) {
...
const ParsedBuffer *BufferTrackerContainer::GetLastGood(
...
BufferTracker *BufferTrackerContainer::FindBufferTrackerOrNull(
    const std::string &uri) {
